...
import (
	...
	"github.com/yndd/nddr-organization/internal/controllers"
...
var startCmd = &cobra.Command{
	Use:          "start",
	Short:        "start the organization nddo intent manager",
	Long:         "start the organization ndd0 intent manager",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		nddcopts := &shared.NddControllerOptions{
			Logger:    logging.NewLogrLogger(zlog.WithName("organization")),
			Poll:      pollInterval,
			Namespace: namespace,
		}
